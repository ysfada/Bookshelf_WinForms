...
//namespace Bookshelf.Components.ChartTypes.FinancialCharts.Stock
//{
//	/// <summary>
...
//            var imagePath = mainForm.CurrentSamplePath;
//			imagePath += "\\";
...
//				var pointIndex = random.Next(0, chart1.Series["Price"].Points.Count);
...
//			var high = rand.NextDouble() * 40;

//			// The first Close value
//			var close = high - rand.NextDouble();

//			// The first Low value
//			var low = close - rand.NextDouble();

//			// The first Open value
//			var open = ( high - low ) * rand.NextDouble() + low;

//			// The first Volume value
//			var volume = 100 + 15 * rand.NextDouble();
