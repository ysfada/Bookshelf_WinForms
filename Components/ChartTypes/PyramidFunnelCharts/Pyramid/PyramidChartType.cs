...
namespace Bookshelf.Components.ChartTypes.PyramidFunnelCharts.Pyramid
{
    /// <summary>
    ...
    public class PyramidChartType : UserControl
    {
        ...
        private ComboBox _comboBoxValueType;
        ...
        private void InitializeComponent()
        {
            ...
            System.Windows.Forms.DataVisualization.Charting.DataPoint dataPoint4 =
                new System.Windows.Forms.DataVisualization.Charting.DataPoint(0, 97.300003051757812);
            System.Windows.Forms.DataVisualization.Charting.DataPoint dataPoint5 =
                new System.Windows.Forms.DataVisualization.Charting.DataPoint(0, 45.700000762939453);
            ...
            this._comboBoxValueType = new System.Windows.Forms.ComboBox();
            ...
            this._labelSampleComment.Text = "A Pyramid chart is used to display data that adds up to 100%.";
            ...
            this._panel1.Size = new System.Drawing.Size(304, 288);
            this._panel1.TabIndex = 0;
            // 
            // comboBoxValueType
            // 
            this._comboBoxValueType.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
            this._comboBoxValueType.Items.AddRange(new object[]
            {
                "Linear",
                "Surface"
            });
            this._comboBoxValueType.Location = new System.Drawing.Point(168, 232);
            this._comboBoxValueType.Name = "_comboBoxValueType";
            this._comboBoxValueType.Size = new System.Drawing.Size(136, 22);
            this._comboBoxValueType.TabIndex = 16;
            this._comboBoxValueType.SelectedIndexChanged +=
                new System.EventHandler(this.comboBoxValueType_SelectedIndexChanged);
            // 
            // label1
            // 
            this._label1.Location = new System.Drawing.Point(20, 232);
            this._label1.Name = "_label1";
            this._label1.Size = new System.Drawing.Size(144, 23);
            this._label1.TabIndex = 15;
            this._label1.Text = "&Value Type:";
            ...
            this._comboBox3DDrawingStyle.Location = new System.Drawing.Point(168, 200);
            this._comboBox3DDrawingStyle.Name = "_comboBox3DDrawingStyle";
            this._comboBox3DDrawingStyle.Size = new System.Drawing.Size(136, 22);
            ...
            // label3DDrawingStyle
            // 
            this._label3DDrawingStyle.Location = new System.Drawing.Point(20, 200);
            ...
            // numericUpDownAngle
            // 
            this._numericUpDownAngle.Location = new System.Drawing.Point(168, 168);
            ...
            this._numericUpDownAngle.Size = new System.Drawing.Size(136, 22);
            ...
            // labelAngle
            // 
            this._labelAngle.Location = new System.Drawing.Point(20, 168);
            ...
            // 
            this._numericUpDownMinHeight.Location = new System.Drawing.Point(168, 104);
            ...
            this._numericUpDownMinHeight.Size = new System.Drawing.Size(136, 22);
            ...
            // label4
            // 
            this._label4.Location = new System.Drawing.Point(20, 104);
            ...
            // numericUpDownGap
            // 
            this._numericUpDownGap.Location = new System.Drawing.Point(168, 72);
            ...
            this._numericUpDownGap.Size = new System.Drawing.Size(136, 22);
            this._numericUpDownGap.TabIndex = 7;
            this._numericUpDownGap.Value = new System.Decimal(new int[]
            {
                2,
                0,
                0,
            ...
            this._comboBoxLabelsPlacement.Location = new System.Drawing.Point(168, 40);
            this._comboBoxLabelsPlacement.Name = "_comboBoxLabelsPlacement";
            this._comboBoxLabelsPlacement.Size = new System.Drawing.Size(136, 22);
            ...
            // 
            this._labelOutsideLabelsPlacement.Location = new System.Drawing.Point(20, 40);
            ...
            this._checkBoxShow3D.Checked = true;
            this._checkBoxShow3D.CheckState = System.Windows.Forms.CheckState.Checked;
            this._checkBoxShow3D.Location = new System.Drawing.Point(6, 136);
            ...
            this._comboBoxLabelsStyle.Location = new System.Drawing.Point(168, 8);
            this._comboBoxLabelsStyle.Name = "_comboBoxLabelsStyle";
            this._comboBoxLabelsStyle.Size = new System.Drawing.Size(136, 22);
            ...
            // label2
            // 
            this._label2.Location = new System.Drawing.Point(20, 8);
        ...
        {
            // Bind chart data
            var yValues = new[] {216.1, 125.8, 2.6, 97.3, 45.7, 25.3};
            _chart1.Series["Default"].Points.DataBindY(yValues);

            // Set pyramid data point labels style
            _chart1.Series["Default"]["PyramidLabelStyle"] = (string) _comboBoxLabelsStyle.SelectedItem;

            // Set labels placement
            if (_comboBoxLabelsStyle.SelectedIndex == 0 ||
                _comboBoxLabelsStyle.SelectedIndex == 1)
                _chart1.Series["Default"]["PyramidOutsideLabelPlacement"] =
                    (string) _comboBoxLabelsPlacement.SelectedItem;
            else
                _chart1.Series["Default"]["PyramidInsideLabelAlignment"] =
                    (string) _comboBoxLabelsPlacement.SelectedItem;

            // Set gap between points
            _chart1.Series["Default"]["PyramidPointGap"] = _numericUpDownGap.Value.ToString(CultureInfo.CurrentCulture);

            // Set minimum point height
            _chart1.Series["Default"]["PyramidMinPointHeight"] = _numericUpDownMinHeight.Value.ToString(CultureInfo.CurrentCulture);

            // Set 3D mode
            _chart1.ChartAreas["Default"].Area3DStyle.Enable3D = _checkBoxShow3D.Checked;

            // Set 3D angle
            _chart1.Series["Default"]["Pyramid3DRotationAngle"] = _numericUpDownAngle.Value.ToString(CultureInfo.CurrentCulture);

            // Set 3D drawing style
            _chart1.Series["Default"]["Pyramid3DDrawingStyle"] = (string) _comboBox3DDrawingStyle.SelectedItem;

            // Set value type
            _chart1.Series["Default"]["PyramidValueType"] = (string) _comboBoxValueType.SelectedItem;
        ...
        private void PieChartType_Load(object sender, EventArgs e)
        {
            ...
            _comboBoxValueType.SelectedIndex = 0;
